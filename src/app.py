...
activities = {
    ...
    "Swimming Club": {
        "description": "Improve swimming techniques and compete in inter-school meets",
    ...
    "Debate Team": {
        "description": "Build argumentation and public speaking skills through competitive debates",
